  ...
  computed: {
    tableColumns() {
      return [
        ...
        { prop: 'name', label: this.$t('充值金额') },
        { prop: 'name', label: this.$t('首充') },
        { prop: 'name', label: this.$t('状态') },
        { prop: 'name', label: this.$t('支付渠道') },
        { prop: 'name', label: this.$t('经理人') },
        { prop: 'name', label: this.$t('支付时间') }
      ]
    },
    formItems() {
      return [
        ...
        },
        {
          prop: 'name',
          componentType: 'el-input',
          props: { placeholder: '订单状态' }
        },
        {
          prop: 'name',
          componentType: 'el-input',
          props: { placeholder: '首充状态' }
        },
        {
          prop: 'name',
          componentType: 'el-input',
        ...
        },
        {
          prop: 'name',
          componentType: 'el-input',
          props: { placeholder: '支付渠道' }
        },
        {
          prop: 'name',
          componentType: 'el-input',
          props: { placeholder: '下单时间' }
        },
        {
          prop: 'name',
          componentType: 'el-input',
          props: { placeholder: '支付时间' }
        }
      ]
    },
