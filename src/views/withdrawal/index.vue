<template>
    <div class="wrapper">
        <van-nav-bar title="提现" left-arrow @click-left="$router.go(-1);"></van-nav-bar>
        <div class="content">
            <div class="balance">
            ...
            <div class="form">
                ...
                <van-field class="money-input" type="number" v-model="moneyInput" 
                    placeholder="提款金额" />
                <div class="mode">
                    <div class="mode-title">收款账户</div>
                ...
                <div class="recharge-button">
                    <van-button type="primary" block color="linear-gradient(272deg, #F44848 0%, #FF782D 104%)"
                        :round="true">立即提交</van-button>
                </div>
            </div>
            <div class="illustrate">
                <div class="illustrate-title">提现提示</div>
