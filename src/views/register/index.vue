<template>
    <div class="wrapper">
        <div class="header">
            <div @click="$router.go(-1)"><img src="@/assets/img/go.png" alt=""></div>
            <div @click="$router.push('/login')">已有账户</div>
        </div>
        <div class="content">
            <div class="content-title">注册 Alltech</div>
            <van-form ref="form" class="form" :show-error-message="false" label-width="60">
                ...
                <van-field class="border-box" v-model="form.inviteCode" :disabled="isinviteCode"
                    :placeholder="$t('邀请码')" input-align="left" />
            </van-form>
            <van-button class="login" @click="registerApi" :loading="loading" type="primary" block color="#C1531B"
                :round="true">
                <div>下一步</div>
            </van-button>
