...
export default {
  ...
  computed: {
    tableColumns() {
      return [
        ...
        { prop: 'name', label: this.$t('官方标题') },
        { prop: 'name', label: this.$t('官方图集') },
        { prop: 'name', label: this.$t('点赞数量') },
        { prop: 'name', label: this.$t('官方排序') },
        { prop: 'name', label: this.$t('官方状态') },
        { prop: 'name', label: this.$t('发布时间') }
      ]
    },
    formItems() {
      return [
  ...
  methods: {
    ...
    handleAdd() {
      ...
      this.dialogConfig.title = this.$t('添加官方')
    ...
    handleEdit(row) {
      this.dialogConfig.visible = true
      this.dialogConfig.title = this.$t('编辑官方')
